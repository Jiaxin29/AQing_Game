...
@ccclass
export default class Germany extends BaseCountry {
    @property({
    ...
    public CountryName = 'germany'
    public GameName = null
    // public SecondName = 'Instalar para obtener 90€'
    public Icon = 'Icon/germany'
    public InstallBtn = {bg: 'common/blue_btn2', font: 'herunterladen'}
